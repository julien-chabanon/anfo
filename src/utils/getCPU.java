...
public class getCPU{
  ...
  public static float getCPUBogoMips() throws Exception {
	    final MatchResult matchResult = getCPU.matchSystemFile("/proc/cpuinfo", BOGOMIPS_PATTERN, 1000);
  ...
  public int getNumOfCpus() {
    ...
    public  int getMaxScalingCPUFreq() throws Exception {
        ...
        if(f.exists())
        {
            ...
            int temp = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq");
            if (temp > 0)
            {
                return temp/1000;
            }
    ...
    public  int getMinScalingCPUFreq() throws Exception {
        ...
        if(f.exists())
        {
            ...
            int temp = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq");
            if (temp > 0)
            {
                return temp/1000;
            }
  ...
  public  int getCPUMaxOfCoreAllowed() throws Exception {
	   ...
	   if(f.exists()) 
	   {
		   ...
		   int temp = getCPU.readSystemFileAsInt("/sys/kernel/debug/tegra_hotplug/max_cpus");
		   if (temp > 0)
		   {
			   return temp;
		   }
  ...
  public  int getCPUFrequencyMax() throws Exception {
    return getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_max_freq");
  }
   ...
   public  int getCPUTemp() throws Exception {
	   ...
	   if(f.exists()) 
	   {
		   ...
		   int temp = getCPU.readSystemFileAsInt("/sys/devices/virtual/thermal/thermal_zone0/temp");
		   if (temp > 3)
		   {
			   if(temp > 1000)
			   {
   ...
   public  int getCPUTempHTC() throws Exception {
	   ...
	   if(f.exists()) 
	   {
		   ...
		   int temp = getCPU.readSystemFileAsInt("/sys/htc/cpu_temp");
		   if (temp > 3)
		   {
			   return temp;
		   } 
...
public  int getCPUTempTegra() throws Exception {
	   ...
	   if(f.exists()) 
	   {
		   ...
		   int temp = getCPU.readSystemFileAsInt("/sys/kernel/debug/tegra_thermal/temp_tj");
		   if (temp > 3)
		   {
			   return temp;
		   } 
...
public String getCPUTemperature() throws Exception
{
	 ...
	 File fileTemp2 = new File("/sys/devices/platform/s5p-tmu/temperature");
	   ...
	   if(fileTemp2.exists()) 
	   {
		   ...
		   int temp = getCPU.readSystemFileAsInt("/sys/devices/platform/s5p-tmu/temperature");
		   if (temp > 3)
		   {
			   return temp + "°";
		   } 
  ...
  public  int getActiveCore() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu_on");
	   if(f.exists()) 
	   {
		   ...
		   int ActiveCore = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu_on");
		   if (ActiveCore > 0)
		   {
			   return ActiveCore;
		   } 
  ...
  public  int getMaxActiveCore() throws Exception {
	    return getCPU.readSystemFileAsInt("/sys/devices/system/cpu/kernel_max");
	  }
  
  public  int getCPUFrequencyMin() throws Exception {
	    return getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_min_freq");
	  }
  ...
  public  int getCPU0FrequencyCurrentNormaleWay() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu0/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
...
public  int getCPU0FrequencyCurrentCustomWay() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU1FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu1/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu1/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU2FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu2/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu2/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU3FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu3/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu3/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU4FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu4/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu4/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU5FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu5/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu5/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU6FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu6/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu6/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU7FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu7/cpufreq/scaling_cur_freq");
	   if(f.exists()) 
	   {
		   ...
		   int Active = getCPU.readSystemFileAsInt("/sys/devices/system/cpu/cpu7/cpufreq/scaling_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getMemoryTotal() throws Exception {
	  final MatchResult matchResult = getCPU.matchSystemFile("/proc/meminfo", MEMTOTAL_PATTERN, 1000);
