...
public  int getCPUTempTegra() throws Exception {
 ...
 public  int getCPUFrequencyMaxAllowCPU0() throws Exception {
	 File f = new File("/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
 ...
 public  int getCPUFrequencyMinAllowCPU0() throws Exception {
	 File f = new File("/sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
 ...
 public  int getCPUFrequencyMaxAllowCPU1() throws Exception {
	 File f = new File("/sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
	   ...
	   return getCPUFrequencyMaxAllowCPU0();
	  }

public  int getCPUFrequencyMinAllowCPU1() throws Exception {
	File f = new File("/sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
	   ...
	   return getCPUFrequencyMinAllowCPU0();
	  }

public  int getCPUFrequencyMaxAllowCPU2() throws Exception {
	File f = new File("/sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
...
public  int getCPUFrequencyMinAllowCPU2() throws Exception {
	File f = new File("/sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
...
public  int getCPUFrequencyMaxAllowCPU3() throws Exception {
	File f = new File("/sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
...
public  int getCPUFrequencyMinAllowCPU3() throws Exception {
	File f = new File("/sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq");
		   if (Active > 0)
		   {
			   return Active/1000;
		   } 
...
public  int getCPU0FrequencyCurrentCustomWay() throws Exception {
  ...
  public  int getCPU1FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu1/cpufreq/cpuinfo_cur_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu1/cpufreq/cpuinfo_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU2FrequencyCurrent() throws Exception {
	  ...
	  File f = new File("/sys/devices/system/cpu/cpu2/cpufreq/cpuinfo_cur_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu2/cpufreq/cpuinfo_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
  ...
  public  int getCPU3FrequencyCurrent() throws Exception {
	  File f = new File("/sys/devices/system/cpu/cpu3/cpufreq/cpuinfo_cur_freq");
	   if(f.exists()) 
	   {
	   
		   int Active = SystemUtils.readSystemFileAsInt("/sys/devices/system/cpu/cpu3/cpufreq/cpuinfo_cur_freq");
		   if (Active > 0)
		   {
			   return Active;
		   } 
