...
public class CpuOnly extends AppWidgetProvider {
	...
	int cpu_min;
	 ...
	 public void onDeleted(Context context, int[] appWidgetIds) {
	  ...
	  Toast.makeText(context, "Anfo CPU widget removed from desktop successfully", Toast.LENGTH_SHORT).show();
...
;
	 ...
	 public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds){
	        ...
	        if(pm.isScreenOn())
	        {
	        	...
	        	views = new RemoteViews(context.getPackageName(), R.layout.activity_widget_cpu_only);
	        	...
	        	final int N = appWidgetIds.length;
	   		    ...
	   		    ComponentName thisWidget = new ComponentName(context,CpuOnly.class);
