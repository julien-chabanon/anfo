...
public class AsyncTaskCpuOnly extends AsyncTask<Void, Integer, Void>
{
	int cpu_max;
	int cpu_min;
   	int cpu_current;
   	...
   	CpuOnly bg = new CpuOnly();
   	Context context;
	

	    public AsyncTaskCpuOnly(Context context) {
	...
	protected Void doInBackground(Void... arg0) {
		...
		//You can do the processing here update the widget/remote views.
		   RemoteViews remoteViews = new RemoteViews(context.getPackageName(),
		    R.layout.activity_widget_cpu_only);
		...
		//Set the text with the current time.
			...
			AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
		     ComponentName thisAppWidget = new ComponentName(context.getPackageName(), CpuOnly.class.getName());
