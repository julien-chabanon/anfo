...
protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_wireless);
	  ...
	  handler = new Handler();
	     ...
	     wifiLogo = (ImageView)findViewById(R.id.wifiICon);
		 
		  signalStrenghtWifiText = (TextView)findViewById(R.id.WifiSignal);
		  nameWifiText = (TextView)findViewById(R.id.wifiTest1);
		   wifiIPText = (TextView)findViewById(R.id.wifiTest2);
		   macWifiText = (TextView)findViewById(R.id.wifiTest3);
		   speedWifiText = (TextView)findViewById(R.id.wifiTest4);
		   bssidWifiText = (TextView)findViewById(R.id.wifiTest5);
		   
		   
		    bluetoothLogo = (ImageView)findViewById(R.id.bluetoothICon);
			 
			  signalStrenghtBluetoothText = (TextView)findViewById(R.id.bluetoothSignal);
			  nameBluetoothText = (TextView)findViewById(R.id.bluetoothTest1);
			   scanModeBluetoothText = (TextView)findViewById(R.id.bluetoothTest2);
			   addressBluetoothText = (TextView)findViewById(R.id.bluetoothTest3);
			   
			   GPSLogo = (ImageView)findViewById(R.id.GPSICon);
  			 
  			  titreGPSText = (TextView)findViewById(R.id.GPSSignal);

	  
  			   ScreenLogo = (ImageView)findViewById(R.id.screenICon);
  				 
  			   titreScreenText = (TextView)findViewById(R.id.screenSignal);
  			   text1Screen = (TextView)findViewById(R.id.screenTest1);
  			   text2Screen = (TextView)findViewById(R.id.screenTest2);
