...
public class ControlCore extends Fragment {
    ...
    int cpu_max_core;
    boolean hasAlreadyCheckRoot = false;
	...
	TextView textcpu0details;
  	...
  	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(testMaxCoreAllow == 0)
        {
        	 if(cpu_max_core == 8)
        	 {
        		//myFragmentView.setContentView(R.layout.activity_control_core_app);
            	 myFragmentView = inflater.inflate(R.layout.activity_control_core_octocore, container, false);
            	 isRoot = false;
            	 
            	 
            	 mProgressCPU4 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU4);
                 mProgressCPU5 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU5);
                 mProgressCPU6 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU6);
                 mProgressCPU7 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU7);
                 useCPU4 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu4Info);
                 useCPU5 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu5Info);
                 useCPU6 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu6Info);
                 useCPU7 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu7Info);
                 
                 textcpu4 = (TextView)myFragmentView.findViewById(R.id.textViewCPU4);
             	 textcpu5 = (TextView)myFragmentView.findViewById(R.id.textViewCPU5);
             	 textcpu6 = (TextView)myFragmentView.findViewById(R.id.textViewCPU6);
             	 textcpu7 = (TextView)myFragmentView.findViewById(R.id.textViewCPU7);
             	   	
             	 textcpu4details = (TextView)myFragmentView.findViewById(R.id.textViewCPU4details);
                 textcpu5details  = (TextView)myFragmentView.findViewById(R.id.textViewCPU5details);
                 textcpu6details  = (TextView)myFragmentView.findViewById(R.id.textViewCPU6details);
                 textcpu7details  = (TextView)myFragmentView.findViewById(R.id.textViewCPU7details);
        	 }
        	 
        	 else
        	 {
        		//myFragmentView.setContentView(R.layout.activity_control_core_app);
            	 myFragmentView = inflater.inflate(R.layout.activity_control_core_app, container, false);
            	 isRoot = false;
        	 }
        }
        ...
        {
        	//myFragmentView.setContentView(R.layout.activity_control_core_app_tegra);
        	 myFragmentView = inflater.inflate(R.layout.activity_control_core_app_tegra, container, false);
        	 root = new Root();
        	 isRoot = false;
        }
        ...
        mProgressCPU0 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU0);
        mProgressCPU1 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU1);
        mProgressCPU2 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU2);
        mProgressCPU3 = (ProgressBar) myFragmentView.findViewById(R.id.progressBarCPU3);
        useCPU0 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu0Info);
        useCPU1 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu1Info);
        useCPU2 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu2Info);
        useCPU3 = (TextView)myFragmentView.findViewById(R.id.textViewUseCpu3Info);
        
         textcpu0 = (TextView)myFragmentView.findViewById(R.id.textViewCPU0);
    	 textcpu1 = (TextView)myFragmentView.findViewById(R.id.textViewCPU1);
    	 textcpu2 = (TextView)myFragmentView.findViewById(R.id.textViewCPU2);
    	 textcpu3 = (TextView)myFragmentView.findViewById(R.id.textViewCPU3);
    	   	
    	 textcpu0details = (TextView)myFragmentView.findViewById(R.id.textViewCPU0details);
       	 textcpu1details  = (TextView)myFragmentView.findViewById(R.id.textViewCPU1details);
       	 textcpu2details  = (TextView)myFragmentView.findViewById(R.id.textViewCPU2details);
       	 textcpu3details  = (TextView)myFragmentView.findViewById(R.id.textViewCPU3details);
        
       	 layoutCpu1 = (LinearLayout)myFragmentView.findViewById(R.id.LayoutCPU1);
       	 layoutCpu2 = (LinearLayout)myFragmentView.findViewById(R.id.LayoutCPU2);
       	 layoutCpu3 = (LinearLayout)myFragmentView.findViewById(R.id.LayoutCPU3);
       	 
       	 core1 = (Button)myFragmentView.findViewById(R.id.buttonSingleCore);
       	 core2 = (Button)myFragmentView.findViewById(R.id.buttonDualCore);
       	 core3 = (Button)myFragmentView.findViewById(R.id.buttonTripleCore);
       	 core4 = (Button)myFragmentView.findViewById(R.id.buttonQuadCore);
       	 
       	checkBoxBoot = (CheckBox)myFragmentView.findViewById(R.id.checkBoxSetOnBootCore);
        ...
        t = new Timer(true);
        t.scheduleAtFixedRate(new Action(),500,3000);
    ...
    class Action extends TimerTask 
    {
	    ...
	    public void run() 
	    {
	    	...
	    	try 
	    	{
				if(cpu.getCPUMaxOfCoreAllowed() != 0)
				{
					isRoot = root.isDeviceRooted();
					hasAlreadyCheckRoot = true;
				}
			}
	    	catch (Exception e) 
	    	{
    ...
    public void clickCore(int coreClicka)
    {
    	this.coreClick = coreClicka;
    	 ...
    	 Builder dia_not_root = new AlertDialog.Builder(context);
		 Builder dia_root = new AlertDialog.Builder(context);
